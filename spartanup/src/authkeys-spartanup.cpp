...
*/
/******************************************************************************/
SpartanupKey::SpartanupKey(const std::string& name0)
    : Key(name0)
{
...
/******************************************************************************/
SpartanupKey::SpartanupKey(const Key& otherKey)
    :Key(otherKey)
{
    // ECDSA
    if (keySize == RSA_4096_KEY_LENGTH)
...
/******************************************************************************/
void Key4096Sha3Padding_spartanup::Export(void* acKey)
{
...
/******************************************************************************/
void Key4096Sha3Padding_spartanup::Import(const void* acKey, const std::string& name0)
{
    ACKey4096Sha3Padding* key = (ACKey4096Sha3Padding*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyECDSA_spartanup::Export(void * acKey)
{
...
/******************************************************************************/
void KeyECDSA_spartanup::Import(const void * acKey, const std::string & name0)
{
    ACKeyECDSA* key = (ACKeyECDSA*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyECDSAp521_spartanup::Export(void * acKey)
{
...
/******************************************************************************/
void KeyECDSAp521_spartanup::Import(const void * acKey, const std::string & name0)
{
    ACKeyECDSAP521* key = (ACKeyECDSAP521*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyLMS_spartanup::Import(const void * acKey, const std::string & name0)
{
}
...
/******************************************************************************/
void SpartanupKey::ParseLmsKey(const std::string& filename)
{
    FILE* file;
...
/******************************************************************************/
void SpartanupKey::Parse(const std::string& filename, bool isSecret0)
{
    uint8_t errCode = 0;
    isSecret = isSecret0;
