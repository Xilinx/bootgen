...
#ifndef _BOOTIMAGE_SPARTANUP_H_
#define _BOOTIMAGE_SPARTANUP_H_
...
*/
/******************************************************************************/
class SpartanBootImage : public BootImage
{
public:
    SpartanBootImage(Options& options, uint8_t index);
    ~SpartanBootImage();
    ...
    void OutputOptionalEfusePufHash(void);
    void OutputOptionalPufPDI(void);
