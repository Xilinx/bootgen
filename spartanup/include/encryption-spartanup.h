...
#pragma once
#ifndef _ENCRYPTION_SPARTANUP_CONTEXT_
#define _ENCRYPTION_SPARTANUP_CONTEXT_
...
*/
/******************************************************************************/
class SpartanupEncryptionContext : public EncryptionContext
{
public:
    SpartanupEncryptionContext();
    SpartanupEncryptionContext(const EncryptionContext * other);
    ~SpartanupEncryptionContext();
