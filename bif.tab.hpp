...
#line 116 "../bisonflex/bif.tab.hpp"
   ...
   enum yytokentype {
     ...
     BBRAM_KEK_IV = 361,
     EFUSE_KEK_IV = 362,
     EFUSE_USER_KEK0_IV = 363,
     EFUSE_USER_KEK1_IV = 364,
     USER_KEYS = 365,
     PMCDATA = 366,
     BOOTIMAGE = 367,
     UDF_BH = 368,
     ...
     SPK_FILE = 375,
     SSK_FILE = 376,
     SPK_SIGNATURE_FILE = 377,
     BH_SIGNATURE_FILE = 378,
     HEADER_SIGNATURE_FILE = 379,
     AUTHVALUE = 380,
     ENCRVALUE = 381,
     CHECKSUMVALUE = 382,
     POWNERVALUE = 383,
     ...
     OPT_KEY = 391,
     AUTH_ONLY = 392,
     BOOT_DEVICE_TYPE = 393,
     DEST_DEVICE_TYPE = 394,
     DEST_CPU_TYPE = 395,
     EXCEPTION_LEVEL_TYPE = 396,
     TRUSTZONE_TYPE = 397,
     SPLITMODE = 398,
     DPA_CM = 399,
     SPKSELECT = 400,
...
/* Line 33 of lalr1.cc  */
#line 461 "../bisonflex/bif.tab.hpp"
