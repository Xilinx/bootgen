...
#line 116 "../bisonflex/bif.tab.hpp"
   ...
   enum yytokentype {
     ...
     BBRAM_KEK_IV = 347,
     EFUSE_KEK_IV = 348,
     EFUSE_USER_KEK0_IV = 349,
     EFUSE_USER_KEK1_IV = 350,
     PMCDATA = 351,
     BOOTIMAGE = 352,
     UDF_BH = 353,
     INIT = 354,
     ...
     SPK_FILE = 360,
     SSK_FILE = 361,
     SPK_SIGNATURE_FILE = 362,
     BH_SIGNATURE_FILE = 363,
     HEADER_SIGNATURE_FILE = 364,
     AUTHVALUE = 365,
     ENCRVALUE = 366,
     CHECKSUMVALUE = 367,
     POWNERVALUE = 368,
     ...
     OPT_KEY = 376,
     AUTH_ONLY = 377,
     BOOT_DEVICE_TYPE = 378,
     DEST_DEVICE_TYPE = 379,
     DEST_CPU_TYPE = 380,
     EXCEPTION_LEVEL_TYPE = 381,
     TRUSTZONE_TYPE = 382,
     SPLITMODE = 383,
     DPA_CM = 384,
     SPKSELECT = 385,
...
/* Line 33 of lalr1.cc  */
#line 446 "../bisonflex/bif.tab.hpp"
