...
#line 114 "../bisonflex/bif.tab.hpp"
   ...
   enum yytokentype {
     ...
     SPK_FILE = 333,
     SSK_FILE = 334,
     SPK_SIGNATURE_FILE = 335,
     BH_SIGNATURE_FILE = 336,
     HEADER_SIGNATURE_FILE = 337,
     AUTHVALUE = 338,
     ENCRVALUE = 339,
     CHECKSUMVALUE = 340,
     POWNERVALUE = 341,
     ...
     OPT_KEY = 348,
     AUTH_ONLY = 349,
     BOOT_DEVICE_TYPE = 350,
     DEST_DEVICE_TYPE = 351,
     DEST_CPU_TYPE = 352,
     EXCEPTION_LEVEL_TYPE = 353,
     TRUSTZONE_TYPE = 354,
     SPLITMODE = 355,
     SPKSELECT = 356,
     OR = 357,
...
/* Line 33 of lalr1.cc  */
#line 415 "../bisonflex/bif.tab.hpp"
