...
#ifndef _BIFSCANNER_H_
#define _BIFSCANNER_H_
...
#undef YY_DECL
#define YY_DECL int BIF::FlexScanner::yylex()
...
namespace BIF
{
    class FlexScanner : public yyFlexLexer 
    {
        ...
        private:
            ...
            BIF::BisonParser::semantic_type * yylval;
            BIF::BisonParser::location_type * yylloc;
    };
}
#endif
