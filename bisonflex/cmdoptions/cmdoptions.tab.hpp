...
#line 94 "cmdoptions.tab.hpp"
   ...
   enum yytokentype {
     ...
     _POST_PROCESS = 311,
     _OVERLAYCDO = 312,
     _ENABLE_SUBSYSTEMS = 313,
     _EFUSEPPKBITS = 314,
     _GENERATE_HASHES = 315,
     _PADIMAGEHEADER = 316,
     _SPKSIGNATURE = 317,
     _GENERATE_KEYS = 318,
     PEM = 319,
     ...
     H_BIF_AARCH32 = 446,
     H_BIF_BIGENDIAN = 447,
     H_BIF_BOOTCONFIG = 448,
     H_BIF_COPY = 449,
     H_BIF_CORE = 450,
     H_BIF_DELAY_HANDOFF = 451,
     H_BIF_DELAY_LOAD = 452,
     H_BIF_FILE = 453,
     H_BIF_ID = 454,
     H_BIF_IMAGE = 455,
     H_BIF_METAHDR = 456,
     ...
     H_BIF_SLR = 459,
     H_BIF_TYPE = 460,
     H_BIF_KEYSRCENCR = 461,
     H_BIF_PARENTID = 462,
     H_DPACM_ENABLE = 463,
     H_BIF_USERKEYS = 464,
     HVN_BIF_PCR = 465,
     HVN_BIF_PCR_MINDEX = 466,
     HV_BIF_IMAGESTORE = 467
   };
