...
#line 94 "cmdoptions.tab.hpp"
   ...
   enum yytokentype {
     ...
     H_BIF_AARCH32 = 434,
     H_BIF_BIGENDIAN = 435,
     H_BIF_BOOTCONFIG = 436,
     H_BIF_COPY = 437,
     H_BIF_CORE = 438,
     H_BIF_DELAY_HANDOFF = 439,
     H_BIF_DELAY_LOAD = 440,
     H_BIF_FILE = 441,
     H_BIF_ID = 442,
     H_BIF_IMAGE = 443,
     H_BIF_METAHDR = 444,
     ...
     H_BIF_SLR = 447,
     H_BIF_TYPE = 448,
     H_BIF_KEYSRCENCR = 449,
     H_BIF_PARENTID = 450,
     H_DPACM_ENABLE = 451,
     H_BIF_USERKEYS = 452,
     HVN_BIF_PCR = 453,
     HVN_BIF_PCR_MINDEX = 454,
     HV_BIF_IMAGESTORE = 455
   };
