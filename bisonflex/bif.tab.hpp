...
#line 118 "../bisonflex/bif.tab.hpp"
   ...
   enum yytokentype {
     ...
     BBRAM_KEK_IV = 374,
     EFUSE_KEK_IV = 375,
     EFUSE_USER_KEK0_IV = 376,
     EFUSE_USER_KEK1_IV = 377,
     USER_KEYS = 378,
     PMCDATA = 379,
     BOOTIMAGE = 380,
     UDF_BH = 381,
     ...
     SPK_FILE = 388,
     SSK_FILE = 389,
     SPK_SIGNATURE_FILE = 390,
     BH_SIGNATURE_FILE = 391,
     HEADER_SIGNATURE_FILE = 392,
     AUTHVALUE = 393,
     ENCRVALUE = 394,
     CHECKSUMVALUE = 395,
     POWNERVALUE = 396,
     ...
     OPT_KEY = 404,
     AUTH_ONLY = 405,
     BOOT_DEVICE_TYPE = 406,
     DEST_DEVICE_TYPE = 407,
     DEST_CPU_TYPE = 408,
     EXCEPTION_LEVEL_TYPE = 409,
     TRUSTZONE_TYPE = 410,
     SPLITMODE = 411,
     DPA_CM = 412,
     SPKSELECT = 413,
