...
/******************************************************************************/
class VersalSubSysImageHeader : public SubSysImageHeader
{
public:
    VersalSubSysImageHeader(ImageBifOptions * imgOptions);
    VersalSubSysImageHeader(std::ifstream & ifs);
...
protected:
    VersalImageHeaderStructure * VersalSubSysImageHeaderTable;
};
#endif