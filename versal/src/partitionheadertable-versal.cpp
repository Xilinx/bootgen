...
void VersalPartitionHeaderTable::Link(BootImage & bi)
{
    ...
    if(bi.bifOptions->metaHdrAttributes.encrKeySource != KeySource::None && bi.bifOptions->pdiType == PartitionType::SLR_SLAVE_CONFIG && (bi.options.GetOutputFileNames().size())!=0)
    {
