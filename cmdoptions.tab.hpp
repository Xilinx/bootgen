...
#line 94 "cmdoptions.tab.hpp"
   ...
   enum yytokentype {
     ...
     H_BIF_AARCH32 = 423,
     H_BIF_BIGENDIAN = 424,
     H_BIF_BOOTCONFIG = 425,
     H_BIF_COPY = 426,
     H_BIF_CORE = 427,
     H_BIF_DELAY_HANDOFF = 428,
     H_BIF_DELAY_LOAD = 429,
     H_BIF_FILE = 430,
     H_BIF_ID = 431,
     H_BIF_IMAGE = 432,
     H_BIF_METAHDR = 433,
     ...
     H_BIF_SLR = 436,
     H_BIF_TYPE = 437,
     H_BIF_KEYSRCENCR = 438,
     H_BIF_PARENTID = 439,
     H_DPACM_ENABLE = 440,
     H_BIF_USERKEYS = 441,
     HVN_BIF_PCR = 442,
     HVN_BIF_PCR_MINDEX = 443,
     HV_BIF_IMAGESTORE = 444
   };
