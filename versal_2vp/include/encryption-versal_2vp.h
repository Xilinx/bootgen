...
#pragma once
#ifndef _ENCRYPTION_VERSAL_2VP_CONTEXT_
#define _ENCRYPTION_VERSAL_2VP_CONTEXT_
...
*/
/******************************************************************************/
class Versal_2vpEncryptionContext : public EncryptionContext
{
public:
    Versal_2vpEncryptionContext();
    Versal_2vpEncryptionContext(const EncryptionContext * other);
    ~Versal_2vpEncryptionContext();
