...
#ifndef _BOOTIMAGE_VERSAL_2VP_H_
#define _BOOTIMAGE_VERSAL_2VP_H_
...
*/
/******************************************************************************/
class Versal_2vpBootImage : public BootImage
{
public:
    Versal_2vpBootImage(Options& options, uint8_t index);
    ~Versal_2vpBootImage();
    ...
    void OutputOptionalEfuseHash(void);
    ...
    Section* bootloaderSection;
    Section* hashBlockSection;
    Section* bootloaderHashBlockSection;
