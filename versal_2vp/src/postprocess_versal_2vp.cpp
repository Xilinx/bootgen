...
bool Versal_2vpImageHeader::PostProcessCdo(const uint8_t* cdo_data, Binary::Length_t cdo_size)
{
    void * new_data = NULL;
    size_t new_size = 0;
    ...
    hdr->partition = std::make_unique<Versal_2vpPartition>(hdr, (uint8_t*)new_data, new_size);
