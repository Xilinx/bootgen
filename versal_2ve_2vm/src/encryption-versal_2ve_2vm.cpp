...
-------------------------------------------------------------------------------
*/
#include "encryption-versal_2ve_2vm.h"
...
/******************************************************************************/
Versal_2ve_2vmEncryptionContext::Versal_2ve_2vmEncryptionContext()
    : isBootloader(false)
    , aesSeedexits(false)
    , isPmcData(false)
...
/******************************************************************************/
Versal_2ve_2vmEncryptionContext::Versal_2ve_2vmEncryptionContext(const EncryptionContext* other)
    : isBootloader(false)
    , aesSeedexits(false)
    , isPmcData(false)
    , isAuthenticated(false)
...
Versal_2ve_2vmEncryptionContext::~Versal_2ve_2vmEncryptionContext()
{
    // encryptionAlgorithm is now unique_ptr, automatically deleted
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::SetAesKey(const uint8_t* key)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::SetAesSeedString(const std::string& key)
{
    uint8_t  hexData[256];
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GenerateAesKey(void)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GetEncryptionKeys(Options& options, uint8_t* aesKey,
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::WriteEncryptionKeyFile(const std::string & baseFileName, 
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::ReadEncryptionKeyFile(const std::string& inputFileName)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::PackNextEncryptionKey(uint8_t* aesKeyNext, int aeskeyPtr)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::PackNextIv(uint8_t* aesIVNext, int aesIvPtr)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GetNextKey(uint8_t * keyNext, int ptr)
{
    PackNextEncryptionKey(keyNext, ptr);
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GetNextIv(uint8_t * keyNext, int ptr)
{
    PackNextIv(keyNext, ptr);
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::SetAesSeed(const uint8_t* key)
{
...
/******************************************************************************/
const uint32_t* Versal_2ve_2vmEncryptionContext::GetAesSeed(void)
{
    return aesSeed.get();
}

/******************************************************************************/
const uint32_t* Versal_2ve_2vmEncryptionContext::GetAesKey(void)
{
    return aesKey.get();
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::SetIv(const uint8_t* iv)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::SetIvString(const std::string& IV)
{
    uint8_t  hexData[256];
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GenerateIv(void)
{
...
/******************************************************************************/
const uint32_t* Versal_2ve_2vmEncryptionContext::GetIv(void)
{
    return aesIv.get();
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::GenerateRemainingKeys(Options& options)
{
    uint32_t blocks, x = 0;
...
void Versal_2ve_2vmEncryptionContext::GenerateGreyKey()
{
    ...
    // bhIv and redKey are unique_ptr - automatically cleaned up when going out of scope
#endif
}

/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::AesGcm256HashBlockEncrypt(Options& options, uint8_t *aad, uint32_t aad_len, uint8_t* outBuf, uint8_t ivIncrement)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::ChunkifyAndEncrypt(Options& options, const uint8_t *inBuf, uint32_t inLen,
    uint8_t *aad, uint32_t aad_len, uint8_t* outBuf, uint32_t& outLen)
{
    ...
    /*if (isBootloader)
    {
        ...
        *(x.get() + AES_GCM_IV_SZ - 1) = increment;
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::WarnforDPACMImpactonBootTime(bool dpacmKeyRollingEnable, bool dpacmMaskEnable)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::Process(BootImage& bi, PartitionHeader* partHdr)
{
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::Process(BootImage& bi)
{
    ...
    ChunkifyAndEncrypt(bi.options,
        ...
        sizeof(Versal_2ve_2vmImageHeaderTableStructure) + bi.imageHeaderTable->iht_optional_data_length,
        encryptedDataBuffer.get() /* out*/,
        encryptedLength /* out */);
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::AesGcm256Encrypt(unsigned char* gcm_pt, int pt_len,
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::AesGcm256Decrypt(unsigned char* gcm_pt, int& pt_len,
                                               unsigned char* gcm_key, unsigned char* gcm_iv,
                                               unsigned char* gcm_aad, int aad_len,
                                               unsigned char* gcm_ct, int ct_len,
                                               unsigned char* gcm_tag)
...
/******************************************************************************/
uint32_t Versal_2ve_2vmEncryptionContext::ConfigureEncryptionBlocksforPmcData(BootImage& bi, PartitionHeader* partHdr)
{
    uint32_t totalencrBlocks = 0;
    Binary::Length_t lastBlock = 0;
    std::vector<uint32_t> encrBlocks = partHdr->imageHeader->GetEncrBlocksList();
...
/******************************************************************************/
uint32_t Versal_2ve_2vmEncryptionContext::ConfigureEncryptionBlocksforPartition(BootImage& bi, PartitionHeader* partHdr)
{
    Options& options = bi.options;
    uint32_t totalencrBlocks = 0;
    Binary::Length_t lastBlock = 0;
...
/******************************************************************************/
void Versal_2ve_2vmEncryptionContext::ChunkifyAndProcess(BootImage& bi, PartitionHeader* partHdr)
{
    Options& options = bi.options;
