...
*/
/******************************************************************************/
Versal_2ve_2vmKey::Versal_2ve_2vmKey(const std::string& name0)
    : Key(name0)
{
...
/******************************************************************************/
Versal_2ve_2vmKey::Versal_2ve_2vmKey(const Key& otherKey)
    :Key(otherKey)
{
    // ECDSA
    if (keySize == RSA_4096_KEY_LENGTH)
...
/******************************************************************************/
void Key4096Sha3Padding_versal_2ve_2vm::Export(void* acKey)
{
...
/******************************************************************************/
void Key4096Sha3Padding_versal_2ve_2vm::Import(const void* acKey, const std::string& name0)
{
    ACKey4096Sha3Padding* key = (ACKey4096Sha3Padding*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyECDSA_versal_2ve_2vm::Export(void * acKey)
{
...
/******************************************************************************/
void KeyECDSA_versal_2ve_2vm::Import(const void * acKey, const std::string & name0)
{
    ACKeyECDSA* key = (ACKeyECDSA*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyECDSAp521_versal_2ve_2vm::Export(void * acKey)
{
...
/******************************************************************************/
void KeyECDSAp521_versal_2ve_2vm::Import(const void * acKey, const std::string & name0)
{
    ACKeyECDSAP521* key = (ACKeyECDSAP521*)acKey;
    Loaded = true;
    isSecret = false;
...
/******************************************************************************/
void KeyLMS_versal_2ve_2vm::Export(void * acKey)
{
    if (!Loaded)
    {
        std::string pubsec = (isSecret) ? " (Secret)" : " (Public)";
...
/******************************************************************************/
void KeyLMS_versal_2ve_2vm::Import(const void * acKey, const std::string & name0)
{
}
...
/******************************************************************************/
void Versal_2ve_2vmKey::ParseLmsKey(const std::string& filename)
{
    FILE* file;
...
/******************************************************************************/
void Versal_2ve_2vmKey::Parse(const std::string& filename, bool isSecret0)
{
    uint8_t errCode = 0;
    isSecret = isSecret0;
