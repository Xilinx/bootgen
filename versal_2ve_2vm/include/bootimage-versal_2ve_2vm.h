...
#ifndef _BOOTIMAGE_VERSAL_2VE_2VM_H_
#define _BOOTIMAGE_VERSAL_2VE_2VM_H_
...
*/
/******************************************************************************/
class Versal_2ve_2vmBootImage : public BootImage
{
public:
    Versal_2ve_2vmBootImage(Options& options, uint8_t index);
    ~Versal_2ve_2vmBootImage();
