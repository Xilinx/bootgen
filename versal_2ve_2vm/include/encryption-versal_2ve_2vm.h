...
#pragma once
#ifndef _ENCRYPTION_VERSAL_2VE_2VM_CONTEXT_
#define _ENCRYPTION_VERSAL_2VE_2VM_CONTEXT_
...
*/
/******************************************************************************/
class Versal_2ve_2vmEncryptionContext : public EncryptionContext
{
public:
    Versal_2ve_2vmEncryptionContext();
    Versal_2ve_2vmEncryptionContext(const EncryptionContext * other);
    ~Versal_2ve_2vmEncryptionContext();
