...
/******************************************************************************/
OutputStream* FpgaBitFile::GetOutputStreamType(void)
{
...
/******************************************************************************/
bool FpgaBitFile::GetBitStripFlag(void)
{
    if (encryptType == Encryption::AES)
    {
        return true;
...
/******************************************************************************/
bool FpgaBitFile::GetPreserveHeaderFlag(void)
{
    if (encryptType == Encryption::AES)
    {
        return true;
...
/******************************************************************************/
bool FpgaBitFile::GetBitPadFlag(bool legacyFlag)
{
...
/******************************************************************************/
void FpgaBitFile::DummyRead(void)
{
    is.ReadLong();
}
