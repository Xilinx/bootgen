...
{
    return Final(&ctx, hashout, GetHashLength());
}
...
/******************************************************************************/
uint8_t HashShake256::GetHashLength(void)
{
    return SHA2_LENGTH_BYTES;
}

/******************************************************************************/
void HashShake256::InitHash(void)
{
    // Currently not supported
}

/******************************************************************************/
uint8_t HashShake256::UpdateHash(const void* data, size_t length)
{
    // Currently not supported
    return 0;
}
...
/******************************************************************************/
uint8_t HashShake256::FinalHash(uint8_t* hashout)
{
    // Currently not supported
    return 0;
}
...
/******************************************************************************/
void HashShake256::CalculateHash(bool flag, const uint8_t *data, size_t length, uint8_t* out)
{
    keccak_state ctx;
    shake256_inc_init(ctx);
    shake256_inc_absorb(ctx, data, length);
    shake256_inc_finalize(ctx);
    shake256_inc_squeeze(out, GetHashLength(), ctx);
}

/******************************************************************************/
std::string HashShake256::GetHashFileExtension(void)
{
    return ".shake256";
}

/******************************************************************************/
uint8_t HashSha3_256::GetHashLength(void)
{
    return SHA2_LENGTH_BYTES;
}

/******************************************************************************/
void HashSha3_256::InitHash(void)
{
    // Currently not supported
}

/******************************************************************************/
uint8_t HashSha3_256::UpdateHash(const void* data, size_t length)
{
    // Currently not supported
    return 0;
}
...
/******************************************************************************/
uint8_t HashSha3_256::FinalHash(uint8_t* hashout)
{
    // Currently not supported
    return 0;
}
...
/******************************************************************************/
void HashSha3_256::CalculateHash(bool flag, const uint8_t *data, size_t length, uint8_t* out)
{
    keccak_state ctx;
...
/******************************************************************************/
std::string HashSha3_256::GetHashFileExtension(void)
{
    return ".sha3_256";
}
